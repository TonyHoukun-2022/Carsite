...
public class BidsController : ControllerBase
{
  ...
  public async Task<ActionResult<BidDto>> PlaceBid(string auctionId, int amount)
  {
    ...
    if (auction == null)
    {
      // grpc communicate to auction svc
    ...
    {
      return BadRequest("You cannot bid on your own car");
    }
  ...
  [HttpGet("{auctionId}")]
  public async Task<ActionResult<List<BidDto>>> GetBidsForOneAuction(string auctionId)
  {
