...
import { getBidsForAuction } from '@/app/apis/auctionApi'
...
export default function BidList({ user, auction }: Props) {
  ...
  //  find the highest bid amount among a list of bids. It also ensures that only bids with a status that includes 'Accepted' are considered. 
